...
parser.add_argument('--num_epoch', type=int, default=100, help='Batch size during training [default: 100]')
...
IMG_H = 208
RATIO = 0.4 # take 20% of dataset as validation data
# BATCH_SIZE = 128
CAPACITY = 20000
...
logs_dir = "logs/quality_" + str(QUALITY) + "/"
logs_train_dir = "logs/quality_" + str(QUALITY) + "/" + "train/"
logs_val_dir = "logs/quality_" + str(QUALITY) + "/" + "val/"
...
os.system('cp %s %s' % ("model.py", logs_dir)) # bkp of model def
